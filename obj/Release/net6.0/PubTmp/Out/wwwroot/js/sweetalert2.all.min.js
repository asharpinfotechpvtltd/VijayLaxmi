    ...
    var b = function (n) {
        ...
        g = function (t) {
            ...
            if ((t.titleText ? (m.innerText = t.titleText) : (m.innerHTML = t.title.split("\n").join("<br />")), t.backdrop || D([document.documentElement, document.body], o["no-backdrop"]), t.text || t.html)) {
                if ("object" === p(t.html))
                    if (((b.innerHTML = ""), 0 in t.html)) for (var v = 0; v in t.html; v++) b.appendChild(t.html[v].cloneNode(!0));
            ...
            t.showCloseButton ? (y.setAttribute("aria-label", t.closeButtonAriaLabel), W(y)) : K(y),
                (e.className = o.popup),
                t.toast ? (D([document.documentElement, document.body], o["toast-shown"]), D(e, o.toast)) : D(e, o.modal),
            ...
            t.imageUrl
                ...
                t.buttonsStyling && ((x.style.backgroundColor = t.confirmButtonColor), (h.style.backgroundColor = t.cancelButtonColor)),
                ...
                t.buttonsStyling
                    ? D([x, h], o.styled)
                    : ($([x, h], o.styled), (x.style.backgroundColor = x.style.borderLeftColor = x.style.borderRightColor = ""), (h.style.backgroundColor = h.style.borderLeftColor = h.style.borderRightColor = "")),
            ...
            if ("undefined" != typeof window) {
                ...
                return new Promise(function (t, e) {
                    ...
                    for (
                        var u = function (t) {
                            ...
                            b = function (t) {
                                ...
                                switch (e.type) {
                                    case "mouseover":
                                    case "mouseup":
                                        r.buttonsStyling && (p ? (a.style.backgroundColor = s(r.confirmButtonColor, -0.1)) : d && (i.style.backgroundColor = s(r.cancelButtonColor, -0.1)));
                                        break;
                                    case "mouseout":
                                        r.buttonsStyling && (p ? (a.style.backgroundColor = r.confirmButtonColor) : d && (i.style.backgroundColor = r.cancelButtonColor));
                                        break;
                                    case "mousedown":
                                        r.buttonsStyling && (p ? (a.style.backgroundColor = s(r.confirmButtonColor, -0.2)) : d && (i.style.backgroundColor = s(r.cancelButtonColor, -0.2)));
                                        break;
                                    case "click":
                                        if (p && n.isVisible())
                        ...
                        (v[C].onclick = b), (v[C].onmouseover = b), (v[C].onmouseout = b), (v[C].onmousedown = b);
                    if (
                        ((Y().onclick = function () {
                            l("close");
                        }),
                                ...
                                if ("Enter" !== e.key || e.isComposing)
                                    if ("Tab" === e.key) {
                                        ...
                                        -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key)
                                            ...
                                            : ("Escape" !== e.key && "Esc" !== e.key) || !0 !== r.allowEscapeKey || l("esc");
                                else if (e.target === w()) {
                                    if ("textarea" === e.target.tagName.toLowerCase()) return;
                                    n.clickConfirm(), e.preventDefault();
                                }
                            })),
                        r.buttonsStyling && ((E.style.borderLeftColor = r.confirmButtonColor), (E.style.borderRightColor = r.confirmButtonColor)),
                    ...
                    ("select" !== r.input && "radio" !== r.input) ||
                        (r.inputOptions instanceof Promise
                            ...
                            ? sn(r.inputOptions)
                            : i("Unexpected type of inputOptions! Expected object or Promise, got " + p(r.inputOptions))),
                        (function (n, t, e) {
                            var a = A(),
                                s = B();
